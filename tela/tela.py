...
class TelaDocker(DockWidget):
    ...
    def Variables(self):
        ...
        self.mode = [True, False, False, False]
        self.eraser = False
        # Canvas
    ...
    def Connects(self):
        ...
        self.layout.set_0.toggled.connect(self.Menu_Display)
        self.layout.set_1.toggled.connect(self.Menu_Display)
        self.layout.set_2.toggled.connect(self.Menu_Display)
    ...
    def Krita_2_Tela(self):
        if self.sync == False:
            ...
            if ((self.canvas() is not None) and (self.canvas().view() is not None)):
                ...
                # Thumbnail
                doc_thumb = ad.thumbnail(doc_width, doc_height)
    ...
    def Panel_Update(self):
        if ((self.canvas() is not None) and (self.canvas().view() is not None)):
            self.panel.Update_Panel(
                ...
                self.layout.panel.width(), self.layout.panel.height(),
    ...
    def Menu_Display(self):
        self.mode[0] = self.layout.set_0.isChecked()
        self.mode[1] = self.layout.set_1.isChecked()
        self.mode[2] = self.layout.set_2.isChecked()
        self.Menu_Shrink()
        if self.mode[0] == True:
        ...
        if self.mode[2] == True:
            ...
            self.layout.gui_horizontal_group.setSizePolicy(QSizePolicy.Preferred, QSizePolicy.Preferred)
            self.layout.gui_vertical_group.setSizePolicy(QSizePolicy.Preferred, QSizePolicy.Preferred)
