...
class Panel(QWidget):
    ...
    # Relay
    def Update_Panel(self, status, q_image, eraser, sof_1, sof_2, sof_3, can_rotation, can_zoom, exposure, gamma, doc_width, doc_height, ui_d_ref, delta_new, gui_hor_norm, gui_ver_norm, panel_width, panel_height, gray_natural, gray_contrast):
        self.status = status
