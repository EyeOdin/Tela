...
class Record(QMainWindow):
    ...
    def Variables(self):
        ...
        self.height = 500
        self.pixmap = QPixmap()
        self.resolution_x = 1920 # Youtube Resolution
        self.resolution_y = 1080 # Youtube Resolution
        self.origin_x = 0
        self.origin_y = 0
    ...
    def resizeEvent(self, event):
        self.origin_x = (self.size().width() * 0.5) - (self.resolution_x * 0.5)
        self.origin_y = (self.size().height() * 0.5) - (self.resolution_y * 0.5)
